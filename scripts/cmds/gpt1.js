...
var config={name:'gpt1',version:'1.0',author:'Finn Fetcher'/** I don't care if you want to change it or not, if you want to change it, go ahead. */,countDown:5,role:0,longDescription:'Chat GPT',category:'ai',guide:{en:'{pn} <query>'}};
...
async function gpt(text,userID,message,mid,api){
  try{
    ...
    message.reply(`𝗚𝗣𝗧\n\n${tx}`,(error,info)=>global.GoatBot.onReply.set(info.messageID,{commandName:'gpt1',author:userID}));
  }catch(error){
